...
const AddPage = () => {
  ...
  // add chapter , remove the lecture or remove a chapter function
              ...
              <div className={addPageStyles.modalContent}>
                ...
                <div className="flex gap-2 sm:gap-3 pt-2">
                  ...
                  <button
                    ...
                    className={`${addPageStyles.modalButton} ${addPageStyles.modalButtonCompactSecondary}`}
                  >
                    Cancel
                  </button>
                </div>
