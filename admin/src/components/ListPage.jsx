...
const ListPage = () => {
  ...
  const fetchCourses = async () => {
    ...
    try {
      ...
      }); // this is the output we will get from mongodb
  ...
  // filter the course (by name,category)
    ...
    <div className={listStyles.pageContainer}>
      ...
      <div className={listStyles.contentContainer}>
        <div className={listStyles.headerContainer}>
          ...
          <p>Manage and browse your courses - clean , light and elegant</p>
        </div>
