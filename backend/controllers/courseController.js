...
// compute fields for tatallecture , course , duration
...
export const deleteCourse = async (req, res) => {
  try {
    ...
    // remove upload file fro the local uploads folder
    try {
...
export const rateCourse = async (req, res) => {
  try {
    ...
    // herer if rating is given by user it will update else it will create a new rating
    ...
    course.avgRating = avgRating; // if a particular couse has multi use rating then it will compute the avg
