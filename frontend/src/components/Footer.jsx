          ...
          <div>
            ...
            <div className={footerStyles.contactSpace}>
              ...
              <div className={footerStyles.contactItem}>
                <div
                  className={`${footerStyles.iconWrapper} ${contactIconGradients.address}`}
                >
                  <MapPin className={iconColors.cyan600} />
                </div>
              ...
              <div className={footerStyles.contactItem}>
                <div
                  className={`${footerStyles.iconWrapper} ${contactIconGradients.phone}`}
                >
                  <Phone className={iconColors.purple600} />
                </div>
              ...
              <div className={footerStyles.contactItem}>
                <div
                  className={`${footerStyles.iconWrapper} ${contactIconGradients.email}`}
                >
                  <Mail className={iconColors.emerald600} />
                </div>
          ...
          <div className={footerStyles.socialContainer}>
            <div className={footerStyles.socialIconsContainer}>
              {socialIcons.map((social, index) => {
                const IconComponent = iconMap[social.iconKey] || Facebook;
                return (
                  <a
                    key={social.name}
                    href={social.url}
            ...
            <div className={footerStyles.designCredit}>
              <div className={footerStyles.designCreditContainer}>
                <div className={footerStyles.designCreditContainer}></div>
