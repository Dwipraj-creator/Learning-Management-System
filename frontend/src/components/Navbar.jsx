  ...
  return (
    ...
    className={ `${navbarStyles.navbar} ${
          ...
          <div className={navbarStyles.authContainer}>
            {!isSignedIn ? (
              <button
                type="button"
                onClick={openSignUp}
                className={navbarStyles.createAccountButton}
              >
                Create Account
              </button>
            ) : (
          ...
          <div className={navbarStyles.mobileMenuContainer}>
            ...
            {!isSignedIn ? (
                <button type="button" onClick={()=>{
                    ...
                    navbarStyles.mobileCreateActionButton ?? navbarStyles.mobileLoginButton
                }>
      ...
      <div className={navbarStyles.backgroundPattern}>
            <div className={navbarStyles.pattern}>
            </div>
      </div>
    </nav>
  );
